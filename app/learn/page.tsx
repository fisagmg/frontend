...
export default function LearnPage() {
  ...
  const [completedLabsData, setCompletedLabsData] = useState<
    CompletedLabItem[]
  >([]);
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="flex items-baseline gap-1.5 mb-1">
                      <span className="text-5xl font-bold text-white">
                        {progressData?.completedCount !== undefined
                    ...
                    >
                      <CardHeader className="p-2.5 pb-1 space-y-0">
                        <div className="flex justify-between items-start gap-2">
                          <CardTitle
                            className="text-sm font-bold text-zinc-900 line-clamp-1 group-hover:text-emerald-600 transition-colors"
                            title={item.outline}
                          >
                            {item.cveName}
                          </CardTitle>
